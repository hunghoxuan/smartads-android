...
import com.stech.smartads.adapters.SingleChoiceAdapter;
...
public class SingleChoiceFragment extends Fragment {
    ...
    private static final String TAG = SingleChoiceFragment.class.getSimpleName();
    ...
    public static SingleChoiceFragment getInstance(Activity act, QuestionObj question) {
    ...
    private void initUI(View view) {
        ...
        adapter = new SingleChoiceAdapter(self, questionObj.getAnswers(), new SingleChoiceListener() {
            @Override
            public void onChecked(int index,AnswerObj answerObj) {
                questionObj.updateSingleChoice(index,answerObj);
